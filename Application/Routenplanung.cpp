...
int main()
{
    ...
    auto res0 = Core::Utility::DeltaEncode_sInt32(5);
    auto res1 = Core::Utility::DeltaEncode_sInt32(127);
    auto res2 = Core::Utility::DeltaEncode_sInt32(323);
    //auto res3 = Core::Utility::DeltaEncode_sInt32(16384);
    //auto res4 = Core::Utility::DeltaEncode_sInt32(160223);
